...
import { ExampleNetworkData } from './example-network-data';
import { VisNetworkOptions,
  VisNetworkService,
  VisNodes,
  VisEdges,
  VisNetworkData
} from 'ng2-vis/components';
...
@Component({
  ...
  template: `
      ...
      <p>
        <strong>Note:</strong> 
        Open your dev tools to see the console output when the network receives click events.
      </p>
    `,
})
